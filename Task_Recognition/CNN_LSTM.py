...
class CNN_LSTM():
    ...
    def createSingleLSTMModel(self,sequenceLength, cnnNumClasses,numOutputClasses):
        inputt = layers.Input(shape=(sequenceLength, cnnNumClasses))
        bLSTM = layers.Bidirectional(layers.GRU(numOutputClasses, return_sequences=False))(inputt)
        ...
        model = tensorflow.keras.models.Model(inputs=inputt, outputs=out)
