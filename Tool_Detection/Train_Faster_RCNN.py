...
from sklearn.metrics import f1_score, precision_score, recall_score, multilabel_confusion_matrix, balanced_accuracy_score
...
class Train_Faster_RCNN:
    ...
    def train(self):
        if FLAGS.save_location == "":
            ...
            # self.final_metrics(self.model_all, data_gen_val)
